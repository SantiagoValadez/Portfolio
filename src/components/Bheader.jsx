const Bheader = () => {
  ...
  <div class="mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
      <a class="mr-5 hover:text-gray-900 text-xl text-slate-300 cursor-pointer" href="#Projects">About me</a>
      <a class="mr-5 hover:text-gray-900 text-xl text-slate-300 cursor-pointer">Projects</a>
      <a class="mr-5 hover:text-gray-900 text-xl text-slate-300 cursor-pointer">Certifications</a>
    </nav>
