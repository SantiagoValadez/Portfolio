...
const Container = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      ...
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">I am a dedicated and enthusiastic self-taught web developer with expertise in HTML, CSS, JavaScript, React, and Java. Through hands-on projects, I have gained practical experience applying these technologies to create efficient, user-friendly web solutions.
Although I don't have professional work experience yet, I am eager to learn, grow, and bring value to the company that places its trust in me. My goal is to contribute innovative ideas and continuously improve my skills to succeed in the tech industry.
The projects I have worked on incorporate the following technologies: HTML, CSS, JavaScript, React, and Java
      </p>  
    </div>
